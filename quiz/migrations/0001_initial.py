    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gifts', models.ManyToManyField(to='quiz.shop')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='quiz.subjects')),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('level', models.CharField(choices=[('beginner', 'Beginner'), ('intermediate', 'Intermediate'), ('advanced', 'Advanced')], default='beginner', max_length=100)),
                ('balls', models.IntegerField(blank=True)),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tests', to='quiz.subjects')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
